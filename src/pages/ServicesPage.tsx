      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Choose the right service level for your needs</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-gray-200">
              <div className="text-center mb-6">
                ...
                <div className="text-sm text-gray-500">per property per month</div>
              </div>
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span className="text-sm">Tenant verification</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-blue-500 relative">
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span className="text-sm">Virtual house tours</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                ...
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span className="text-sm">Deposit management</span>
                </div>
                <div className="flex items-center space-x-2">
                  <CheckCircle className="w-4 h-4 text-green-500" />
                  <span className="text-sm">Video reports</span>
                </div>
              </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-8 border-2 border-gray-200">
              <div className="text-center mb-6">
                ...
                <div className="text-3xl font-bold text-blue-600 mb-2">₹7,999</div>
                <div className="text-sm text-gray-500">per property per month</div>
              </div>
              <div className="space-y-3 mb-8">
                <div className="flex items-center space-x-2">
